        ...
        success: function (result) {
            ...
            list.sortable({
                update: function (event, ui) {
                    ...
                    var newOrder = list.sortable('toArray', { attribute: 'data-buildID' });
...
$(document).ready(function () {
    ...
    // Make the reference image list sortable
    $('#referenceImageList').sortable({
        axis: 'y', // Only allow sorting vertically
        cursor: 'move', // Change cursor to "move" while dragging
        placeholder: 'sortable-placeholder', // Custom class for the placeholder
        handle: '.drag-handle', // Use elements with class "drag-handle" as handles
        start: function (event, ui) {
            // Callback function called when sorting starts
            console.log('Sorting started');
        },
        stop: function (event, ui) {
            // Callback function called when sorting stops
            console.log('Sorting stopped');
        },
        update: function (event, ui) {
            // Callback function called when the sort order changes
            console.log('Sort order changed');
            // Here you can save the new sort order
        }
    });
});